...
class ReceiptPlaceholderPage extends StatelessWidget {
  final String orderId;

  const ReceiptPlaceholderPage({super.key, required this.orderId});
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: Colors.black,
            leading: IconButton(
              icon: const Icon(Icons.arrow_back, color: Color(0xFFD4A027)),
              onPressed: () {
